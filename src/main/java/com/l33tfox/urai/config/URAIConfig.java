...
public class URAIConfig implements ConfigData {
    ...
    @ConfigEntry.Gui.Tooltip
    public String gameStartIntroMessage = "Hello! I'm Gemini, your AI assistant. Want to chat? Just start your message with \"Hey Gemini\". To keep things fair and avoid spam, I can only reply once every 2 seconds. Good luck with the PvP!";
